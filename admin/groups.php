    ...
    <div class="flex min-h-screen">
        ...
        <aside class="w-64 bg-gray-900 text-white">
            ...
            <nav class="p-4 space-y-1">
                ...
                <a href="groups.php" class="flex items-center space-x-3 px-4 py-2.5 bg-blue-600 rounded-lg text-sm font-medium">
        ...
        <main class="flex-1 p-8">
            <div class="flex items-center justify-between mb-8">
                ...
                <button onclick="openModal()" class="bg-blue-600 text-white px-5 py-2.5 rounded-lg hover:bg-blue-700 font-medium transition text-sm">+ 新建分组</button>
            </div>
